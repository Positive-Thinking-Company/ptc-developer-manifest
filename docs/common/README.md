# Introduction on common themes

Before going to the specifics themes of each kind of project, let's talk about **common themes** that apply for backend and frontend development.
